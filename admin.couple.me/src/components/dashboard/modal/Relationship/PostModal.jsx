...
export default function PostModal({ onSave }) {
  ...
  const [imageSrc, setImageSrc] = useState(""); // Use 'value' for the description
    ...
    >
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content position-relative">
          ...
          <h2 className="form-label font-bold text-lg h-9 flex items-center">Add Relationship</h2>
            <form>
              <div className="mb-3">
