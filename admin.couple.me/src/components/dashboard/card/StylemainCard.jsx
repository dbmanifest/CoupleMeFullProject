...
export default function StylemainCard({ data, onEdit, onDelete }) {
  return (
    <tr>
        ...
        <div className="freelancer-style1 p-0 mb-0 box-shadow-none">
          <div className="d-lg-flex align-items-lg-center">
            <div className="thumb w60 position-relative rounded-circle mb15-md">
              <Link href={data.imgSrc} target="blank">
                <Image
                  height={60}
                  width={60}
      ...
      {/* New Image Column */}
      <td>
        <div className="ml15 ml0-md mb15-md">
          <h5 className="mb-0 fz14 list-inline-item mb5-sm pe-1">{data.value}</h5>
        </div>
      </td>
      <td className="text-right"> {/* Align the action buttons to the right */}
